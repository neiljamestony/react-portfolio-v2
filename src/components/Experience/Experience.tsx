...
import { MobileExperienceTitle, MobileExperienceContainer, MobileExperienceDataContainer, MobileExperienceTimelineBox, ExperienceTimelineStick, MobileExperienceTextContainer, MobileExperienceInactiveYear, MobileExperienceActiveYear, MobileExperienceName, MobileExperienceCompany } from './Style'
                          ...
                          experiences.map((exp, key) => (
                              <Box key={key} sx={MobileExperienceDataContainer}>
                                  ...
                                  {key !== experiences.length - 0 && (
                                      <Box sx={ExperienceTimelineStick}/>
                                  )}
